<template>
  <div>
    ...
    <div class="border border-gray-800 p-6 bg-gray-900">
      <p class="text-gray-500 text-xs font-mono mb-6">// edit profile</p>
      ...
      <div class="flex flex-col gap-4">
        ...
        <button @click="saveProfile"
          class="border border-pink-400 text-pink-400 px-6 py-2 font-mono text-sm hover:bg-pink-400 hover:text-gray-950 transition-all w-fit">
          {{ saved ? '✓ saved' : 'save' }}
        </button>
      </div>
    </div>
